...
MILITARY=['解放军','美军','印军','军方','导弹','航母','战机','军工','核武','防务协议','驻军','抗美援朝','解放战争','抗日战争','日本侵华','731部队','黄岩岛','仁爱礁','台海','南海争端','军籍','军演','武器','军事基地','军队','部队','战役','开战','停火']
GEOPOL_DIRECT=['中方','美方','日方','印方','俄方','对华','反制','制裁','贸易战','中美','中日','中印','亲美','反华','靖国神社','藏南','台湾当局','台独','台湾独立','南海','外交博弈','国际局势']
COUNTRIES=['美国','日本','印度','俄罗斯','乌克兰','以色列','伊朗','菲律宾','台湾','朝鲜','韩国','欧盟','法国','英国','德国','加拿大','新西兰','澳大利亚','巴基斯坦']
GEO_CUES=['总统','总理','首相','政府','选举','外交','制裁','关税','军方','军事','导弹','航母','战机','防务','战争','冲突','停火','领土','军队','条约','投降','稀土','美债','反制','对决','靖国','无核','驻军','反华','战败','侵略','军事基地','开第一枪','威胁','让步','主权','边境','联盟','谈判','战事']
