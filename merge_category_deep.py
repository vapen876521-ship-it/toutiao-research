...
PARTY_STATE=['党中央','政治局','中央军委','国务院','外交部','国防部','全国人大','全国政协','省委书记','市委书记','党委书记','纪委书记','纪检监察','严重违纪违法','审查调查','商务部','白宫','五角大楼','美国国会','参议院','众议院','北约','最高检','公安部','扫黑','黑势力','扫黑除恶','反腐','落马','省长','市长','县长','人大代表','政协委员','公职人员']
MILITARY=['解放军','美军','印军','俄军','台军','军方','军机','军警','空军','海军','陆军','武警','军队','军人','军官','军演','军事','军舰','军用','军籍','将军','大校','八路军','联军','军训','军工','核武','防务协议','驻军','导弹','航母','战机','预警机','炸弹','武器','坦克','F-16','F16','歼-20','歼20','歼‑20','歼10','苏-57','霹雳15','轰-6','抗美援朝','解放战争','抗日战争','日本侵华','侵华','731部队','黄岩岛','仁爱礁','台海','南海争端','战役','战争','投降','汉光演习','中业岛','十万大军压境','岳家军','马军战力','战力重估']
GEOPOL_DIRECT=['中方','美方','日方','印方','俄方','对华','反制','制裁','贸易战','中美','中日','中印','亲美','反华','靖国神社','藏南','台湾当局','台独','台湾独立','解决台湾','统一台湾','南海','外交博弈','国际局势','对抗中国','威胁中国','武统','和统','祖国统一','统一进入','大陆布下','辱华','投美','背叛中国','官方全球征缴令','领土争端','主权争端','中国底牌','开第一枪','美国全面衰落','犹太资本','芯片打到瓜子','美国全线解禁TikTok','日本蓄谋','41国对中国发难','朝鲜吃尽中俄','不看美国脸色','美战略彻底溃败','阻击华为','美国转头就禁','中资退出后','美国没来得及出声']
COUNTRIES=['美国','日本','印度','俄罗斯','乌克兰','以色列','伊朗','菲律宾','台湾','朝鲜','韩国','欧盟','法国','英国','德国','加拿大','新西兰','澳大利亚','巴基斯坦','越南','波兰','欧洲']
GEO_CUES=['总统','总理','首相','政府','选举','外交','制裁','关税','军方','军事','导弹','航母','战机','防务','战争','冲突','停火','领土','军队','条约','投降','稀土','美债','反制','对决','靖国','无核','驻军','反华','战败','侵略','军事基地','开第一枪','威胁','让步','主权','边境','联盟','谈判','战事','防长','现役军人','对抗','统一','武统','和统','白宫','五角大楼','国会','北约','商务部','征税','反倾销','禁令','出口管制','封锁','叛逃','叛徒','汉奸','击落','参战','军舰','战力','贸易战','公告','停手','关系','援助','中资','铁路项目','大豆','出口商品','向朝鲜出口','试射','摊牌','发难','焦虑','咬牙切齿','回过神','王牌','底牌']
MULTI_COUNTRY_COMBAT=['焦虑','沉默','咬牙切齿','回过神','摊牌','对决','发难','护盘','王牌','底牌','怒怼']
...
def political(r):
    ...
    country_hits=sum(x in t for x in COUNTRIES)
    if country_hits and any(k in t for k in GEO_CUES):return True
    if country_hits>=2 and any(k in t for k in MULTI_COUNTRY_COMBAT):return True
    return False
